...
object DuoBattleManager {
    ...
    fun onBattleStarted(battleId: UUID, p1: ServerPlayer, p2: ServerPlayer) {
    ...
    fun handleSelectionDisconnect(loser: ServerPlayer, winner: ServerPlayer) {
    ...
    fun handlePlayerQuit(player: ServerPlayer) {
    ...
    private fun startNextRound(
        winnerPlayer: ServerPlayer, winnerTeam: DuoTeam,
        loserPlayer: ServerPlayer, loserTeam: DuoTeam,
    ...
    private fun DuoTeam.getActivePlayer(): ServerPlayer = if (currentIndex == 0) player1 else player2
